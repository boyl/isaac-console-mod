...
- `workshop-mod/`：中文版正式源码，当前版本 `2.5.7`，Workshop ID `3776882944`。
- `workshop-mod-en/`：英文版正式源码，当前内部版本 `2.5.4-en.2`、metadata `2.5.4.2`，Workshop ID `3779128726`。
- `tests/workshop-mod/`：Lua Mock 回归和英文发布负载验证器。
...
- 中文版：`47E3B166CB0E1C56D0A8DB19F7C1063786ACE9A740A8E193E83391ED1B0B2100`
...
使用 `tests/workshop-mod/run_mock_game_tests.py` 执行完整英文回归，使用 `run_cold_start_tests.py` 对中英文执行首次手柄导航回归，并对英文候选运行 `validate_workshop_mod.py`。
