...
EXPECTED_VERSION = sys.argv[3] if len(sys.argv) > 3 else "2.5.4-en.17"
LUA_DLL_CANDIDATES = [
...
def scenarios() -> list[dict[str, object]]:
    ...
    result.extend(
        [
            ...
            {
                "scenario": "all_entry_favorites",
                "label": "1162 stable favorite keys recent order mouse isolation and 64 KiB budget",
                "repPlus": True,
                "eid": True,
                "screenWidth": 1280,
                "screenHeight": 720,
            ...
            {
                "scenario": "custom_commands",
                "label": "custom raw passthrough stable ids lifecycle routing transactions and 64 KiB capacity",
                "repPlus": True,
                "eid": True,
            },
            ...
            },
            {
                ...
                "label": "MCM startup hint controller favorite and command-close persistence rollback",
                "repPlus": True,
                "eid": False,
                "mcm": True,
            },
